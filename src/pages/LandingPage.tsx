      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button onClick={() => scrollToSection('security')} className="text-gray-700 hover:text-blue-600 transition-colors font-medium">
              Bảo mật
            </button>
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="/login" className="px-5 py-2.5 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors font-medium">
              Đăng nhập
            </a>
            <a href="/register" className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg hover:shadow-lg transition-all font-medium">
              Đăng ký
            </a>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-2 border-t pt-4">
            ...
            <button onClick={() => scrollToSection('security')} className="block w-full text-left px-4 py-2 text-gray-700 hover:bg-blue-50 rounded-lg">
              Bảo mật
            </button>
            <button onClick={() => scrollToSection('download')} className="block w-full text-left px-4 py-2 text-gray-700 hover:bg-blue-50 rounded-lg">
              Tải về
            </button>
            <a href="/login" className="block px-4 py-2 text-blue-600 hover:bg-blue-50 rounded-lg">
              Đăng nhập
            </a>
            <a href="/register" className="block px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg text-center">
              Đăng ký
            </a>
          </div>
        )}
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-32 text-center">
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <a href="/register" className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl hover:shadow-2xl transition-all font-semibold flex items-center gap-2">
...
const FeatureCard = ({ icon: Icon, title, description, gradient }) => {
  return (
    <div className="group relative p-8 bg-white rounded-2xl hover:shadow-2xl transition-all duration-300 border border-gray-100">
      <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${gradient} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
            Tính năng <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">nổi bật</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
              An toàn & <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">Bảo mật</span>
            </h2>
          ...
          <div className="relative">
            <div className="aspect-square bg-gradient-to-br from-green-100 to-blue-100 rounded-3xl p-12 flex items-center justify-center">
              <div className="w-full h-full bg-white rounded-2xl shadow-2xl p-8 flex flex-col items-center justify-center space-y-6">
                <div className="w-24 h-24 bg-gradient-to-br from-green-500 to-blue-500 rounded-full flex items-center justify-center animate-pulse">
...
const DownloadSection = () => {
  return (
    <section id="download" className="py-24 bg-gradient-to-br from-blue-600 to-purple-600 text-white">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 hover:bg-white/20 transition-all">
            ...
            <button className="px-6 py-2 bg-white text-blue-600 rounded-lg font-semibold hover:shadow-lg transition-all">
              Tải về
            </button>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 hover:bg-white/20 transition-all">
            ...
            <a href="/login" className="inline-block px-6 py-2 bg-white text-blue-600 rounded-lg font-semibold hover:shadow-lg transition-all">
              Sử dụng ngay
            </a>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="/register" className="px-8 py-4 bg-white text-blue-600 rounded-xl hover:shadow-2xl transition-all font-bold text-lg">
            Đăng ký miễn phí
          </a>
    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl font-bold text-white">ZaloChat</span>
            </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm opacity-75">
          <p>&copy; 2024 ZaloChat. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
