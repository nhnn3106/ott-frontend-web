...
export const API_CHAT_SERVER_URL = "http://192.168.5.130:5000/api";
export const SOCKET_CHAT_SERVER_URL = "http://192.168.5.130:5000";
export const API_MEDIA_SERVER_URL = "http://192.168.5.130:8080/riff/api/media";
